...
DIRECT_PYTHON_ENTRYPOINTS = (
    ...
    "scripts/build_issue_66_chat_conversion_matrix.py",
    ...
    "scripts/run_issue_395_cli_chat_v2_lifecycle.py",
    "scripts/run_issue_62_live_control.py",
    "scripts/update_pricing_snapshot.py",
...
def test_relative_windows_entrypoints_keep_the_repository_runtime_contract() -> None:
    ...
    assert '"version":"0.2.6"' in portable_plan.stdout
