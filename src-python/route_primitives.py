...
UPSTREAM_USER_AGENT = "CodexHub/0.2.17 (+https://github.com/noirbright/CodexHub)"
...
# Must cover Extra High TTFB. Do not cut first-byte wait shorter than the
# request timeout; T3/official xhigh was 504'd at 180s while timeout was 300s.
DEFAULT_MAIN_GENERATION_PRE_RESPONSE_BUDGET_SECONDS = float(
