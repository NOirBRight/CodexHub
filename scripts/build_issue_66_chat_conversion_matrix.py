...
def _request_fields() -> list[dict[str, Any]]:
    ...
    return [
        ...
        _row(
            ...
            chat="function tool with injective alias and exact input/output envelopes",
            disposition="reversibly_adapted",
            when="exact text-format declaration and accepts_custom_adapter capability",
            fail_closed=True,
            implementation="runtime_tool_compatibility",
            notes="Request-scoped and not implied by Collaboration V2 support.",
        ),
        _row(
            ...
            when="adapter capability absent or declaration/envelope is malformed",
            fail_closed=True,
            implementation="runtime_tool_compatibility",
