...
Issue: #369<br>
Candidate: `7006542a773fc20c10e4bbcadd593393a259ceb2`<br>
...
```powershell
py -3.13 scripts/validate_issue_369_matrix.py --candidate-sha 7006542a773fc20c10e4bbcadd593393a259ceb2
```
